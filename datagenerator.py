...
#        samples,
#        shape=(intcols, frameSize),
#        strides=(samples.strides[0] * hopSize, intsamples.strides[0])).copy()
#    frames *= win
...
class DataGenerator(object):
        ...
        for i in range(self.n_speaker):
            ...
            for j in wav_dir_i:
                if i not in self.speaker_file:
                    self.speaker_file[i] = []
                if j.endswith(r".wav") or j.endswith(r".WAV"):
                    self.speaker_file[i].append(j)
        print(self.speaker_file)
        # ipdb.set_trace()
        # self.reinit()
    ...
    def reinit(self):
        ...
        #pickle.dump(self.samples, open('deep-clustering-master/pkl_folder/train.pkl', 'wb'))
        pickle.dump(self.samples, open('deep-clustering-master/pkl_folder/val.pkl', 'wb'))
...
if __name__ == '__main__':
    print("begin datagenerator.py!")
    #data_dir = r'C:\Users\changjac\Google Drive\HP Intern\EE\deep-clustering-master\TIMIT_dataset\TRAIN' # '/media/nca/data/raw_data/speech_train_rs/'
    data_dir = r'C:\Users\changjac\Google Drive\HP Intern\EE\deep-clustering-master\TIMIT_dataset\TEST' # '/media/nca/data/raw_data/speech_train_rs/'
    # data_dir = 'speech/'
